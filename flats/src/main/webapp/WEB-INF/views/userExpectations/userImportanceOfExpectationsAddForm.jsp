...
<div class="container">
	...
	<div class="row well">
		<div class="text-center">
			<h3>
				Oceń ważność poszczególnych oczekiwań <a href="javascript:void(0);"
		...
		<div class="row">
			<div class="col-md-7">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<div class="col-xs-10">
							<c:if test="${(not empty userExpectations.location)}">

								<form:input type="range" min="0" max="10" class="form-control " value="5"
									path="location" name="location"
									oninput="OUTlocation.value = (this.value*10)+'%'" />

							</c:if>
							<c:if test="${(empty userExpectations.location)}">

								<form:input type="range" min="0" max="10" class="form-control "
									path="location" name="location" disabled="true" value="0"
									oninput="OUTlocation.value = (this.value*10)+'%'" />
				...
				<c:if
					test="${((empty userExpectations.minNumberOfRooms) and (empty userExpectations.maxNumberOfRooms))}">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="col-xs-10">
								<form:input type="range" min="0" max="10" class="form-control "
									disabled="true" value="0" path="numberOfRooms"
									name="numberOfRooms"
				...
				<c:if
					test="${((not empty userExpectations.minNumberOfRooms) or (not empty userExpectations.maxNumberOfRooms))}">
					<div class="form-group">
						<label class="control-label col-sm-6">Ilość pokoi od
							${userExpectations.minNumberOfRooms} do
							${userExpectations.maxNumberOfRooms} </label>
				...
				<c:if
					test="${((empty userExpectations.minHowOld) and (empty userExpectations.maxHowOld))}">
					<div class="form-group">
						<label class="control-label col-sm-6">Wiek nieruchomości
							od ${userExpectations.minHowOld} do ${userExpectations.maxHowOld}
						</label>
						<div class="col-sm-6">
							<div class="col-xs-10">
								<form:input type="range" min="0" max="10" class="form-control " value="0"
									disabled="true" path="howOld" name="howOld"
				...
				<c:if
					test="${((not empty userExpectations.minHowOld) or (not empty userExpectations.maxHowOld))}">
					<div class="form-group">
						<label class="control-label col-sm-6">Wiek nieruchomości
							od ${userExpectations.minHowOld} do ${userExpectations.maxHowOld}
						</label>
				...
				<c:if
					test="${((empty userExpectations.minFloor) and (empty userExpectations.minFloor))}">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="col-xs-10">
								<form:input type="range" min="0" max="10" class="form-control " 
									disabled="true" value="0" path="floor" name="floor"
				...
				<c:if
					test="${((not empty userExpectations.minFloor) or (not empty userExpectations.minFloor))}">
					<div class="form-group">
						<label class="control-label col-sm-6">Piętro od
							${userExpectations.minFloor} do ${userExpectations.maxFloor} </label>
						<div class="col-sm-6">
			...
			<div class="col-md-5">
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-8">
						<div class="col-xs-10">
							<c:if test="${not empty userExpectations.garage}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="garage" name="garage" value="5"
									oninput="OUTgarage.value = (this.value*10)+'%'" />
							</c:if>
							<c:if test="${empty userExpectations.garage}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="garage" name="garage" disabled="true" value="0"
									oninput="OUTgarage.value = (this.value*10)+'%'" />
							</c:if>
						</div>
						<div class="col-xs-2">
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-8">
						<div class="col-xs-10">
							<c:if test="${not empty userExpectations.parking}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="parking" name="parking" value="5"
									oninput="OUTparking.value = (this.value*10)+'%'" />
							</c:if>
							<c:if test="${empty userExpectations.parking}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="parking" name="parking" disabled="true" value="0"
									oninput="OUTparking.value = (this.value*10)+'%'" />
							</c:if>
						</div>
						<div class="col-xs-2">
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-8">
						<div class="col-xs-10">
							<c:if test="${not empty userExpectations.garden}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="garden" name="garden" value="5"
									oninput="OUTgarden.value = (this.value*10)+'%'" />
							</c:if>
							<c:if test="${empty userExpectations.garden}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="garden" name="garden" disabled="true" value="0"
									oninput="OUTgarden.value = (this.value*10)+'%'" />
							</c:if>
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-8">
						<div class="col-xs-10">
							<c:if test="${not empty userExpectations.cellar}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="cellar" name="cellar" value="5"
									oninput="OUTcellar.value = (this.value*10)+'%'" />
							</c:if>
							<c:if test="${empty userExpectations.cellar}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="cellar" name="cellar" disabled="true" value="0"
									oninput="OUTcellar.value = (this.value*10)+'%'" />
							</c:if>
						</div>
						<div class="col-xs-2">
				...
				<div class="form-group">
					<label class="control-label col-sm-6 col-md-4">Monitoring:
						<c:if test="${userExpectations.monitoring == true}">Tak</c:if> <c:if
							test="${userExpectations.monitoring == false}">Nie</c:if>
					</label>
					<div class="col-sm-6 col-md-8">
						<div class="col-xs-10">
							<c:if test="${not empty userExpectations.monitoring}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="monitoring" name="monitoring" value="5"
									oninput="OUTmonitoring.value = (this.value*10)+'%'" />
							</c:if>
							<c:if test="${ empty userExpectations.monitoring}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="monitoring" name="monitoring" disabled="true" value="0"
									oninput="OUTmonitoring.value = (this.value*10)+'%'" />
							</c:if>
						</div>
						<div class="col-xs-2">
				...
				<div class="form-group">
					...
					<div class="col-sm-6 col-md-8">
						<div class="col-xs-10">
							<c:if test="${not empty userExpectations.lift}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="lift" name="lift" value="5"
									oninput="OUTlift.value = (this.value*10)+'%'" />
							</c:if>
							<c:if test="${empty userExpectations.lift}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="lift" name="lift" disabled="true" value="0"
									oninput="OUTlift.value = (this.value*10)+'%'" />
							</c:if>
						</div>
						<div class="col-xs-2">
				...
				<div class="form-group">
					<label class="control-label col-sm-6 col-md-4">Dostęp do
						...
						<c:if test="${userExpectations.accessToPublicTransport == false}">Nie</c:if>
					</label>
					<div class="col-sm-6 col-md-8">
						<div class="col-xs-10">
							<c:if test="${not empty userExpectations.accessToPublicTransport}">
								<form:input type="range" min="0" max="10" class="form-control " value="5"
									path="accessToPublicTransport" name="accessToPublicTransport"
									oninput="OUTaccessToPublicTransport.value = (this.value*10)+'%'" />
							</c:if>
							<c:if test="${ empty userExpectations.accessToPublicTransport}">
								<form:input type="range" min="0" max="10" class="form-control "
									path="accessToPublicTransport" name="accessToPublicTransport"  disabled="true" value="0"
									oninput="OUTaccessToPublicTransport.value = (this.value*10)+'%'" />
							</c:if>
