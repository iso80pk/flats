		...
		<div class="row">
			<div class="col-sm-8">
				...
				<div class="form-group">
					<label class="control-label col-sm-4">Lokalizacja <a
				...
				<div class="form-group">
					<label class="control-label col-sm-4">Powierzchnia [m2] * <a
						href="javascript:void(0);" data-toggle="tooltip"
						data-placement="bottom"
					...
					<div class="col-sm-4">
						<form:input type="number" min="3" step="0.01" max="99999999.99"
							required="required" path="minFloorArea" name="minFloorArea"
					...
					<div class="col-sm-4">
						<form:input type="number" min="3" step="0.01" max="99999999.99"
							required="required" path="maxFloorArea" name="maxFloorArea"
				...
				<div class="form-group">
					<label class="control-label col-sm-4">Cena * <a
						href="javascript:void(0);" data-toggle="tooltip"
						data-placement="bottom"
					...
					<div class="col-sm-4">
						<form:input type="number" min="100" step="0.01" max="99999999.99"
							required="required" path="minPrice" name="minPrice"
							class="form-control" placeholder="Od" />
						<c:if test="${pageContext.request.method=='POST'}">
							<form:errors path="minPrice" class="my-form-error" />
						</c:if>
					</div>
					<div class="col-sm-4">
						<form:input type="number" min="100" step="0.01" max="99999999.99"
							required="required" path="maxPrice" name="maxPrice"
							class="form-control" placeholder="Do" />
						<c:if test="${pageContext.request.method=='POST'}">
							<form:errors path="maxPrice" class="my-form-error" />
						</c:if>
					</div>
				</div>

				<div class="form-group">
					<label class="control-label col-sm-4">Ilość pokoi <a
						href="javascript:void(0);" data-toggle="tooltip"
						data-placement="bottom"
					...
					<div class="col-sm-4">
						<form:input type="number" min="1" step="1" max="100"
							...
							class="form-control" placeholder="Od" />
						<c:if test="${pageContext.request.method=='POST'}">
							<form:errors path="minNumberOfRooms" class="my-form-error" />
						</c:if>
					</div>
					<div class="col-sm-4">
						<form:input type="number" min="1" step="1" max="100"
							...
							class="form-control" placeholder="Do" />
						<c:if test="${pageContext.request.method=='POST'}">
							<form:errors path="maxNumberOfRooms" class="my-form-error" />
						</c:if>
					</div>
				</div>

				<div class="form-group">
					<label class="control-label col-sm-4">Wiek nieruchomości <a
						href="javascript:void(0);" data-toggle="tooltip"
						data-placement="bottom"
					...
					<div class="col-sm-4">
						<form:input type="number" min="0" step="1" max="500"
							path="minHowOld" name="minHowOld" class="form-control"
							placeholder="Od" />
						<c:if test="${pageContext.request.method=='POST'}">
							<form:errors path="minHowOld" class="my-form-error" />
						</c:if>
					</div>
					<div class="col-sm-4">
						<form:input type="number" min="0" step="1" max="500"
							path="maxHowOld" name="maxHowOld" class="form-control"
							placeholder="Do" />
						<c:if test="${pageContext.request.method=='POST'}">
							<form:errors path="maxHowOld" class="my-form-error" />
						</c:if>
					</div>
				</div>

				<div class="form-group">
					<label class="control-label col-sm-4">Piętro <a
						href="javascript:void(0);" data-toggle="tooltip"
						data-placement="bottom"
					...
					<div class="col-sm-4">
						<form:input type="number" min="0" step="1" max="100"
							path="minFloor" name="minFloor" class="form-control"
							placeholder="Od" />
						<c:if test="${pageContext.request.method=='POST'}">
							<form:errors path="minFloor" class="my-form-error" />
						</c:if>
					</div>
					<div class="col-sm-4">
						<form:input type="number" min="0" step="1" max="100"
							path="maxFloor" name="maxFloor" class="form-control"
							placeholder="Do" />
						<c:if test="${pageContext.request.method=='POST'}">
							<form:errors path="maxFloor" class="my-form-error" />
						</c:if>
					</div>
				</div>
